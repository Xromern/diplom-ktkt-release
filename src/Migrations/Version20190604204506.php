 ...
 */
final class Version20190604204506 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comment ADD comment_id INT DEFAULT NULL, CHANGE article_id article_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE journal_code CHANGE code_id code_id INT DEFAULT NULL, CHANGE date_use date_use DATETIME DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE user DROP comment_id, CHANGE salt salt VARCHAR(255) DEFAULT NULL, CHANGE last_login last_login DATETIME DEFAULT NULL, CHANGE confirmation_token confirmation_token VARCHAR(180) DEFAULT NULL, CHANGE password_requested_at password_requested_at DATETIME DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comment DROP comment_id, CHANGE article_id article_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE journal_code CHANGE code_id code_id INT DEFAULT NULL, CHANGE date_use date_use DATETIME DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE journal_date_mark CHANGE subject_id subject_id INT DEFAULT NULL, CHANGE type_mark_id type_mark_id INT DEFAULT NULL, CHANGE date date DATE DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE journal_group CHANGE curator_id curator_id INT DEFAULT NULL, CHANGE specialty_id specialty_id INT DEFAULT NULL');
