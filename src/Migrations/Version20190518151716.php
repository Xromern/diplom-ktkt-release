 ...
 */
final class Version20190518151716 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE journal_date_mark (id INT AUTO_INCREMENT NOT NULL, subject_id INT DEFAULT NULL, type_mark_id INT DEFAULT NULL, date DATE DEFAULT NULL, description LONGTEXT DEFAULT NULL, INDEX IDX_F4C7C00023EDC87 (subject_id), INDEX IDX_F4C7C0006AB19EDE (type_mark_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE journal_mark (id INT AUTO_INCREMENT NOT NULL, student_id INT DEFAULT NULL, date_id INT DEFAULT NULL, mark VARCHAR(2) DEFAULT NULL, INDEX IDX_DE4CCAF9CB944F1A (student_id), INDEX IDX_DE4CCAF9B897366B (date_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE journal_subject (id INT AUTO_INCREMENT NOT NULL, main_teacher_id INT DEFAULT NULL, group_id INT DEFAULT NULL, type_form_control_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, alis_en VARCHAR(255) NOT NULL, INDEX IDX_2B75709F79780A7E (main_teacher_id), INDEX IDX_2B75709FFE54D947 (group_id), INDEX IDX_2B75709FCC4D1FEE (type_form_control_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
