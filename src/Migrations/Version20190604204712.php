 ...
 */
final class Version20190604204712 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comment ADD user_id INT DEFAULT NULL, DROP comment_id, CHANGE article_id article_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comment ADD comment_id INT DEFAULT NULL, DROP user_id, CHANGE article_id article_id INT DEFAULT NULL');
