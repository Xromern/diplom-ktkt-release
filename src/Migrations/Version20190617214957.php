 ...
 */
final class Version20190617214957 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE menu ADD parents_of_parents_id INT NOT NULL, CHANGE parent_id parent_id INT NOT NULL, CHANGE page_id page_id INT DEFAULT NULL, CHANGE url url VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE menu ADD CONSTRAINT FK_7D053A9322EFD419 FOREIGN KEY (parents_of_parents_id) REFERENCES menu (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE menu DROP parents_of_parents_id, CHANGE parent_id parent_id INT DEFAULT NULL, CHANGE page_id page_id INT DEFAULT NULL, CHANGE url url VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
