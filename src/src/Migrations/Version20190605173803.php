 ...
 */
final class Version20190605173803 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE journal_code DROP FOREIGN KEY FK_CF2D081027DAFE17');
        $this->addSql('DROP INDEX UNIQ_CF2D081027DAFE17 ON journal_code');
        $this->addSql('ALTER TABLE journal_code ADD user_id INT DEFAULT NULL, ADD role VARCHAR(255) NOT NULL, DROP code_id, CHANGE date_use date_use DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE journal_code ADD CONSTRAINT FK_CF2D0810A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_CF2D0810A76ED395 ON journal_code (user_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comment CHANGE article_id article_id INT DEFAULT NULL, CHANGE user_id user_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE journal_code DROP FOREIGN KEY FK_CF2D0810A76ED395');
        $this->addSql('DROP INDEX UNIQ_CF2D0810A76ED395 ON journal_code');
        $this->addSql('ALTER TABLE journal_code ADD code_id INT DEFAULT NULL, DROP user_id, DROP role, CHANGE date_use date_use DATETIME DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE journal_code ADD CONSTRAINT FK_CF2D081027DAFE17 FOREIGN KEY (code_id) REFERENCES user (id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_CF2D081027DAFE17 ON journal_code (code_id)');
        $this->addSql('ALTER TABLE journal_date_mark CHANGE subject_id subject_id INT DEFAULT NULL, CHANGE type_mark_id type_mark_id INT DEFAULT NULL, CHANGE date date DATE DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE journal_group CHANGE curator_id curator_id INT DEFAULT NULL, CHANGE specialty_id specialty_id INT DEFAULT NULL');
