 ...
 */
final class Version20190523184258 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE journal_mark (id INT AUTO_INCREMENT NOT NULL, student_id INT DEFAULT NULL, mark VARCHAR(2) DEFAULT NULL, subject_id INT DEFAULT NULL, INDEX IDX_DE4CCAF9CB944F1A (student_id), INDEX IDX_DE4CCAF923EDC87 (subject_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
