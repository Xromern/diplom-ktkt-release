 ...
 */
final class Version20190618004900 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE journal_student CHANGE group_id group_id INT DEFAULT NULL, CHANGE code_id code_id INT DEFAULT NULL, CHANGE email1 email1 VARCHAR(255) DEFAULT NULL, CHANGE email2 email2 VARCHAR(255) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE menu CHANGE page_id page_id INT DEFAULT NULL, CHANGE pid pid INT DEFAULT NULL, CHANGE url url VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE journal_student CHANGE group_id group_id INT DEFAULT NULL, CHANGE code_id code_id INT DEFAULT NULL, CHANGE email1 email1 VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, CHANGE email2 email2 VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci');
        $this->addSql('ALTER TABLE journal_subject CHANGE main_teacher_id main_teacher_id INT DEFAULT NULL, CHANGE group_id group_id INT DEFAULT NULL, CHANGE type_form_control_id type_form_control_id INT DEFAULT NULL, CHANGE grading_system_id grading_system_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE journal_teacher CHANGE code_id code_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE menu CHANGE pid pid INT DEFAULT NULL, CHANGE page_id page_id INT DEFAULT NULL, CHANGE url url VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
